...
static uint32_t g_output_bh_enable[NUM_OUTPUT_ENABLE_WORDS] = { 0x00000007U, 0x00000000U, 0x00000000U, 0xC0000000U };
/**
...
uint8_t vl53lmz_dci_write_data(VL53LMZ_Configuration *p_dev, uint8_t *data, uint32_t index, uint16_t data_size) {
    ...
    uint8_t footer[] = { 0x00, 0x00, 0x00, 0x0f, 0x05, 0x01, (uint8_t) ((data_size + (uint16_t) 8) >> 8),
